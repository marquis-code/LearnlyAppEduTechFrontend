        ...
        <div class="flex h-16 flex-shrink-0 border-b border-gray-200 bg-white lg:border-none">
          ...
          <div class="flex flex-1 justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div class="ml-4 flex items-center md:ml-6">
              <button type="button"
                class="relative sr-only rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2">
